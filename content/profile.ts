...
export const projects: Project[] = [
  {
    ...
    summary: "Концепт премиального сайта для бренда украшений из янтаря: утончённая типографика, свободное пространство и крупные кадры изделий.",
    ...
    liveUrl: "https://lumine-jewelry-concept.vercel.app",
    tags: ["Figma", "UI/UX", "Web Design", "E-Commerce", "Design System"],
    deliverables: ["Дизайн-система", "UI Kit", "Прототип мобильной версии", "Адаптивный десктоп"]
  },
  {
    slug: "lobby",
    ...
    gallery: [
      "/projects/lobby-cover.jpg",
      "/projects/lobby-detail.jpg"
    ],
    summary: "Минималистичный интернет-магазин концептуальной одежды: акцент на визуале товара, монохромной палитре и бесшовном пользовательском пути.",
    ...
    liveUrl: "https://lobby-concept-store.vercel.app",
    tags: ["UI/UX", "Mobile First", "Figma", "E-Commerce", "Minimalism"],
    deliverables: ["UX Research", "Wireframes", "UI Дизайн", "Интерактивный кликабельный прототип"]
  },
  {
    slug: "tutor-landing",
    ...
    gallery: [
      "/projects/tutor-cover.jpg",
      "/projects/tutor-detail.jpg"
    ],
    summary: "Конверсионный лендинг с чётким оффером, интерактивным калькулятором программы, социальными доказательствами и формой быстрой записи.",
    ...
    liveUrl: "https://tutor-edu-landing.vercel.app",
    tags: ["Landing Page", "Conversion UX", "Figma", "EdTech"],
    deliverables: ["Прототипирование", "Копирайтинг & структура", "UI Дизайн", "Адаптивные экраны"]
  }
];
...
export const profile: Profile = {
  ...
  about: "Алия. Веб-дизайнер, который помогает продуктам расти за счёт визуальной ясности, ритма и понятного пути пользователя.",
  aboutShort: "Алия. Веб-дизайнер, который помогает сайту расти за счёт ясности, ритма и понятного пути пользователя.",
  aboutFull: "Алия. Веб-дизайнер, который помогает продуктам расти за счёт ясности, ритма и понятного пути пользователя.\n\nСпециализируюсь на создании удобных интерфейсов, e-commerce проектов, мобильных приложений и конверсионных посадочных страниц. Работаю в связке с разработчиками, создаю масштабируемые дизайн-системы и детально продумываю пользовательский путь от первого клика до целевого действия.",
  telegram: "@aliya",
  telegramUrl: "https://t.me/aliya",
  telegramLabel: "Telegram: @aliya",
