...
import { Globe, ArrowLeft, ArrowUpRight, Calendar, Play } from "lucide-react";
      ...
      <article className="min-h-dvh bg-black text-white pb-20">
        <div className="mx-auto w-full max-w-2xl px-4 pt-6 sm:px-6">
          ...
          <header className="mt-8">
            ...
            {/* Quick Action Links: Figma & In-App Live Site */}
            <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              >
                ...
                <Play size={14} className="text-zinc-400 group-hover:text-white transition" />
              </button>
            </div>
          </header>
          ...
          {/* Embedded Live Preview in Case Study */}
          <section className="mt-10">
            <div className="flex items-center justify-between mb-3">
              <h2 className="text-[18px] font-bold text-white">
                Интерактивный прототип проекта
              </h2>
              <button
                type="button"
                onClick={() => setIsPreviewOpen(true)}
            ...
            <div className="relative overflow-hidden rounded-2xl border border-zinc-800 bg-[#0d0d10] shadow-2xl h-[480px]">
              <iframe
                src={project.liveUrl}
                title={project.title}
